...
class RostersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create roster" do
    assert_difference('Roster.count') do
      post rosters_url, params: { roster: { details: @roster.details, player: @roster.player } }, as: :json
    end
  ...
  test "should update roster" do
    patch roster_url(@roster), params: { roster: { details: @roster.details, player: @roster.player } }, as: :json
    assert_response 200
  end
